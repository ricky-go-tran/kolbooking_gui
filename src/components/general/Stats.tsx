  ...
  return (
    <div className="bg-white py-24 sm:py-32 dark:bg-gray-800">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h1 className="mb-4 text-4xl text-center mx-auto align-middle font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          Application of Industry 4.0 technology
        </h1>
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
          We are present in the fields of cuisine, travel, fashion, healthcare,
          and many more.
        </p>
