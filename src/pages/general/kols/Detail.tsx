...
const Detail = () => {
  ...
  return (
    <>
      { data !== null && <div className="min-h-screen w-full bg-gray-100 flex py-4">
            ...
            <div className="bg-white shadow-xl rounded-lg py-3 max-w-xs">
              <div className="photo-wrapper p-2">
                <img
                  ...
                  src={data?.avatar === undefined || data.avatar === "null"
                  ...
                  <tbody>
                    <tr>
                      <td className="px-11 py-2">
                        {data?.kol?.data?.attributes?.instagram_path !== "null" &&
                    ...
                    <tr>
                      <td className="px-11 py-2">
                        {data?.kol?.data?.attributes?.facebook_path !== "null" &&
            ...
            <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10">
              <div className="grid grid-cols-2 row-gap-8 md:grid-cols-4">
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">{data?.follow_num}</h6>
                  <p className="font-bold">Follower</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">{data?.job_complete_num}</h6>
                  <p className="font-bold">Complete Jobs</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">{data?.like_num}</h6>
                  <p className="font-bold">Like</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">{data?.unlike_num}</h6>
        ...
        <div className="w-11/12 bg-white rounded h-auto shadow-xl my-2">
          <div className="mx-5 my-7">
            ...
            <div className="flex flex-wrap my-5">
              {data?.kol?.data?.attributes?.industry?.data.map((industry: any) => {
                return (
