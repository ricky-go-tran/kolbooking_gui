  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 flex py-4">
      <div className="w-1/4 flex flex-col items-center justify-start">
        <div id="basic-info" className="max-w-">
        ...
        <div id="socical-media" className="max-w-xs mt-5">
          <div className="w-full">
        ...
        <div className="w-11/12 bg-white rounded h-auto shadow-xl my-2">
          <div className="mx-5 my-7">
            ...
            <p className="my-5 text-sm   text-gray-900 dark:text-gray-400">
              ...
              requests, incidents, and changes. Track work across the enterprise
              ...
              rapidly respond to requests, incidents, and changes. Track work
              across the enterprise through an open, collaborative platform.
              Link issues across Jira and ingest data from other software
              development tools, so your IT support and operations teams have
              richer contextual information to rapidly respond to requests,
            ...
            <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10">
              <div className="grid grid-cols-2 row-gap-8 md:grid-cols-4">
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">144K</h6>
                  <p className="font-bold">Follower</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">32.1K</h6>
                  <p className="font-bold">Complete Jobs</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">12.9K</h6>
                  <p className="font-bold">Like</p>
                </div>
                <div className="text-center">
                  <h6 className="text-3xl font-bold text-blue-600">24.5K</h6>
